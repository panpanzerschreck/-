...
/*////////////////////////////////////////////////////////////////
/                                                                /
/                 Алгоритм множення матриці                      /
/                                                                /
////////////////////////////////////////////////////////////////*/



// Лінійне множення матриць
...
// Множення матриць Алгоритмом Штрассена
Matrix strassen(Matrix A, Matrix B, size N) {
    ...
    // Створимо нову матрицю для збереження результату
    Matrix C = createMatrix(N);

    size K = N / 2;

    // Нова суб-матриця (підматриця)
